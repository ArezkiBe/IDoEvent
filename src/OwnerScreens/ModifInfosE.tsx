...
export default class ModifInfos extends Component<Props> {
  ...
  validationMDP = () : boolean =>{
    if(this.state.NvMotDePasse.length==0){
      this.setState({
        messageError : "Le champs mot de passe est vide."
      });
      return false;
    }

    else if(this.state.NvMotDePasse.length<6){
      this.setState({
        messageError : "Le mot de passe est trop court (6 caractères min.)"
      });
      return false;
    }
    else if(this.state.NvMotDePasse.length > 25){
      this.setState({
    ...
    return (
      ...
      <View style={styles.container}>
            ...
            <View style={{flexDirection:'row'}}>
                ...
                <View style={{paddingLeft: 19,width:230,marginTop:100}}>
                  ...
                  <Image style={{width:180, height:600, left: 30}} source={require('../../assets/feuille.jpg')}/> 
